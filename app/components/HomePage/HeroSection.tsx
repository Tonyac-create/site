                    ...
                    <div className="flex flex-col lg:flex-row-reverse lg:gap-14">
                        ...
                        <div className="lg:w-1/2">
                            ...
                            <div className="flex flex-col gap-5 mx-6 sm:flex-row sm:gap-10 sm:justify-center lg:flex-col lg:gap-5">
                                <Button href="/adopt" variant="primary" className="w-full sm:w-1/2 mt-10">Donnez une seconde chance</Button>
                                <Button href="/help" variant="secondary" className="w-full sm:w-1/2 sm:mt-10 lg:mt-0">Je deviens adhérent</Button>
                            </div>
                        </div>
                    </div>
                </div>
