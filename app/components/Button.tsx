...
const Button: React.FC<ButtonProps> = ({ href, children, className, variant = 'primary' }) => {
  ...
  const variantClasses = variant === 'primary' ? 'bg-white text-brown border-2 border-green md:text-2xl hover:bg-brown hover:text-green' : 'bg-green text-brown border-2 border-green md:text-2xl hover:bg-brown hover:text-green';
