...
export default function LPOSection() {
    ...
    return (
        <section className="mx-6 pt-16 lg:mx-28 flex flex-col">
            <h2 className="text-brown text-4xl font-lora font-semibold">Nous sommes refuge LPO</h2>
            <p className="text-xl mt-3 mb-8">{`Un Refuge LPO est un terrain privé (petit ou grand jardin, cour ou balcon…) ou public
            ...
            <Link
                ...
                target="_blank"
                className="flex gap-2 text-xl mt-3 mb-8 underline underline-offset-4">
            ...
            <p className="text-xl mt-3 mb-8">{`Cela nous permet, entre autres, de faire une animation de`}
